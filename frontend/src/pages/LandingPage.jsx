  ...
  return (
    <div>
      ...
      <section className="support-center">
        ...
        <div id="support-para">Explore our resources or contact us for personalized support</div>
        <div className="support-grid">
          <div className="support-box">
            <img src="/chat-logo.png" alt="Chat Now" className="support-icon" />
            <h2>Chat Now</h2>
            <p><i>Click to open live chat</i></p>
          </div>
          <div className="support-box">
            <img src="/email-logo.png" alt="Email Us" className="support-icon" />
            <h2>Email Us</h2>
            <p><i>Send us a message, and we’ll respond shortly</i></p>
          </div>
          <div className="support-box">
            <img src="/faq-img.png" alt="Browse FAQs" className="support-icon" />
            <h2>Browse FAQs</h2>
            <p><i>Get answers to common questions</i></p>
          </div>
          <div className="support-box">
            <img src="/call-img.png" alt="Call Us" className="support-icon" />
            <h2>Call Us</h2>
            <p><i>Talk to our support team directly</i></p>
          </div>
        </div>
